...
bot.command({
   ...
   $onlyIf[$getUserVar[premium;$authorID]==false;**⛔ You have already redeemed your perk**]
    $onlyIf[$hasRole[$authorID;ROLE ID]==true;{description:**⛔ You aren't a \`booster\` in my** [support server](link)}{color:RED}]
    $onlyForServers[YOUR GUILD ID;{description:**⛔ You can use this command only in my** [support server]link)}{color:RED}]`
   })
   ...
   /*And put this in all your premium commands $onlyIf[$getUserVar[premium;$authorID]==true;**⛔ You need \`premium\` to use this command**]
   here's an example*/
